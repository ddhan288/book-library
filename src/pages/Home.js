...
import MiniCaurosel from "../components/MiniCaurosel";
  ...
  return (
    <div className="w-full relative bg-white h-[1080px] text-left text-6xl text-dimgray-600 font-inter">
      ...
      <div className="absolute top-[48px] left-[341px] rounded-tl-none rounded-tr-3xs rounded-b-none w-[1544px] h-[994px] overflow-y-auto">
        ...
        <div className="absolute top-[136px] left-[634px] rounded-3xs bg-white box-border w-[863px] h-[235px] overflow-hidden text-center text-white border-[1px] border-solid border-tomato-300">
          ...
          <NewArivals />
          <div className="absolute top-[229px] left-[13px] w-[848px] h-[233px]">
