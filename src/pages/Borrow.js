...
const Borrow = () => {
  ...
  return (
    <div className="w-full relative bg-white h-[1080px] text-left text-mini text-dimgray-600 font-inter">
      ...
      />
      <div className="absolute top-[47px] left-[341px] w-[1544px] h-[996px] text-base text-darkgray-200">
        ...
        <div className="absolute top-[80px] left-[526px] w-[484px] h-[843px]">
          <div className="absolute top-[0px] left-[0px] w-[484px] h-[843px] text-center text-dimgray-600">
            <div className="absolute top-[0px] left-[0px] rounded-3xs bg-white w-[484px] h-[843px]" />
            <div className="absolute top-[298px] left-[67px] w-[317px] h-[51px]">
          ...
          <div className="absolute top-[397px] left-[67px] w-[359px] h-[101px]">
          ...
          <div className="absolute top-[524px] left-[70px] w-[359px] h-[150px]">
            <div className="absolute top-[42px] left-[0px] w-[359px] h-[108px]">
              <div className="absolute top-[0px] left-[0px] rounded-3xs bg-white box-border w-[359px] h-[108px] border-[1px] border-solid border-lightgray-100" />
              <div className="absolute top-[18px] left-[17px] font-medium inline-block w-[255px] h-[31px]">{`Purpose `}</div>
            </div>
            <div className="absolute top-[0px] left-[0px] font-medium text-black inline-block w-[146px] h-[31px]">
              Description
            </div>
          </div>
          <div className="absolute top-[251px] left-[67px] font-medium text-black inline-block w-[114px] h-[31px]">
            To
          </div>
        </div>
      </div>
