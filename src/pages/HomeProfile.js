...
const HomeProfile = () => {
  ...
  const onFavouriteTextClick = useCallback(() => {
    navigate("/favourite");
  }, [navigate]);
  ...
  return (
    <div className="w-full relative bg-white h-[1080px] text-left text-mini text-dimgray-600 font-inter">
      <img
        className="absolute top-[-67px] left-[-37px] w-[1994.3px] h-[1143.5px]"
        alt=""
        src="/bg-vector.svg"
      />
      <div className="absolute top-[48px] left-[341px] rounded-tl-none rounded-tr-3xs rounded-b-none w-[1544px] h-[994px] overflow-y-auto text-6xl">
      ...
      <div className="absolute top-[48px] left-[341px] w-[1544px] h-[246px] text-center">
        ...
        <div className="absolute top-[38px] left-[812px] w-[455px] h-[46px] font-abel">
        ...
        <div className="absolute top-[38px] left-[615px] w-[170px] h-[47px] text-xl">
        ...
        <div className="absolute top-[38px] left-[1293px] w-[203px] h-52 text-left">
          <div
            className="absolute top-[0px] left-[0px] rounded-14xl bg-white shadow-[0px_0px_4px_rgba(0,_0,_0,_0.25)] w-[203px] h-[50px] cursor-pointer"
          ...
          />
          <div className="absolute top-[14px] left-[66px] text-xl leading-[128.52%] inline-block w-[134px] h-[27px]">
            Kenson
          </div>
          <img
            ...
            src="/polygon-1.svg"
          />
          <div className="absolute top-[63px] left-[48px] rounded-3xs bg-white shadow-[0px_0px_4px_rgba(0,_0,_0,_0.25)] box-border w-[155px] h-[145px] border-[1px] border-solid border-lightgray-200" />
          <div
            className="absolute top-[82px] left-[66px] inline-block w-[102px] h-[17px] cursor-pointer"
            onClick={onProfileTextClick}
          >
            Profile
          </div>
          <div
            className="absolute top-[110px] left-[66px] inline-block w-[117px] h-[17px] cursor-pointer"
            onClick={onFavouriteTextClick}
          >
            Favourite
          </div>
          <div
            className="absolute top-[138px] left-[66px] inline-block w-[117px] h-[17px] cursor-pointer"
            onClick={onPaymentsTextClick}
          >
            Payments
          </div>
          <div
            className="absolute top-[166px] left-[66px] inline-block w-[117px] h-[17px] cursor-pointer"
            onClick={onLogoutTextClick}
          >
            Logout
          </div>
        </div>
        <div className="absolute top-[38px] left-[46px] w-[541px] h-[49px] text-left text-xl">
