...
const HomeSearchAll = () => {
  ...
  return (
    <div className="w-full relative bg-white h-[1080px] text-left text-6xl text-dimgray-600 font-inter">
      ...
      <div className="absolute top-[48px] left-[341px] w-[1544px] h-[373px] text-center text-xl">
        ...
        <div className="absolute top-[38px] left-[1293px] w-[203px] h-[50px] text-left">
