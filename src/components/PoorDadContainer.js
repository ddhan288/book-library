...
const PoorDadContainer = ({ propTop, onFrameContainer3Click }) => {
  ...
  return (
    <div
      className="absolute top-[587px] left-[44px] w-[1454px] h-[125px] text-left text-xl text-dimgray-600 font-inter"
      style={groupDivStyle}
    >
        ...
        <div className="flex flex-row items-center justify-start gap-[47px]">
          ...
          <div className="flex flex-col items-start justify-start">
            <div className="flex flex-col items-start justify-start gap-[20px]">
              <div className="w-[207px] relative leading-[128.52%] inline-block h-3.5 shrink-0">
                Rich Dad Poor Dad
              </div>
              <div className="w-[202px] relative text-mini leading-[128.52%] inline-block h-3.5 shrink-0">
...
export default PoorDadContainer;
